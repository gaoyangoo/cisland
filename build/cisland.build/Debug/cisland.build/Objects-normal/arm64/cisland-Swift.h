...
#ifndef CISLAND_SWIFT_H
#define CISLAND_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="cisland",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC7cisland11AppDelegate")
...
SWIFT_CLASS("_TtC7cisland11IslandPanel")
@interface IslandPanel : NSPanel
...
@class NSCoder;
@class NSWindow;
SWIFT_CLASS("_TtC7cisland22IslandWindowController")
@interface IslandWindowController : NSWindowController
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
...
@class CLLocation;
SWIFT_CLASS("_TtC7cisland14WeatherService")
