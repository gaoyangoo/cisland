...
struct ThemeColors {
    ...
    static let dark = ThemeColors(
        ...
        cardBackgroundAlt: .black.opacity(0.90),
    ...
    static let light = ThemeColors(
        ...
        tabBarBackground: Color(white: 0.94),
        searchFieldBackground: Color(white: 0.96),
        snippetRow: Color(white: 0.98),
        snippetRowEditing: Color(white: 0.96),
