...
public struct IslandContainerView: View {
    ...
    @State private var tapGesture: UITapGestureRecognizer?
    ...
    public var body: some View {
        ...
        .frame(width: IslandSize.compact.width, height: IslandSize.compact.height)
        .onTapGesture {
            handleTap()
        }
